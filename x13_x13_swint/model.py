...
class x13(nn.Module):
    ...
    def forward(self, rgb_f, depth_f, next_route, velo_in):  # , gt_ss):
        ...
        if isinstance(SC_features0, list):
            ...
            local_features2 = SC_features0[2]  # Stage 3 (1/16 resolution)
        ...
        hx = self.necks_net(
            cat([self.up(RGB_features8).to("cuda:0"), SC_features1.to("cuda:0")], dim=1))
        # print(hx.shape)
