...
class vit_bb_ss(nn.Module):
    ...
    # Expand the class token to the full batch
        ...
        # print("output decoder: ", ss_f_3.shape)
        ss_f_2 = self.conv2_ss_f(self.up(ss_f_3))
        # print("output decoder: ", ss_f_2.shape)
        ss_f_1 = self.conv1_ss_f(self.up(ss_f_2))
        # print("output decoder: ", ss_f_1.shape)
        ss_f_0 = self.conv0_ss_f(self.up(ss_f_1))
        # print("output decoder: ", ss_f_0.shape)
        ...
        redl_stops = self.tls_predictor(RGB_features0)
        ...
        hx = self.necks_net(cat([RGB_features0, SC_features8], dim=1))
