...
class swint_x13_x13(nn.Module):
    ...
    def __init__(self, config, device):
        ...
        self.checkpoint_file = './swint_x13_x13_v5/upernet_swin_base_patch4_window7_512x512_160k_ade20k_pretrain_224x224_22K_20210526_211650-762e2178.pth'
        # Load model config
    ...
    def forward(self, rgb_f, depth_f, next_route, velo_in):
        ...
        if isinstance(RGB_features0, list):
            ...
            #     [local_features_resized, local_features_resized1, local_features_resized2, global_features], dim=1)
        # print("output encoder: ", RGB_features0.shape)
        # ignore class token
