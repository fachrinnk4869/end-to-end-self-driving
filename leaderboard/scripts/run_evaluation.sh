...
export SAVE_PATH=/media/fachri/banyak/endtoend/data/ADVERSARIAL/${WEATHER}/${MODEL}-${CONTROL_OPTION}-old # ADVERSARIAL NORMAL
export ROUTES=leaderboard/data/all_routes/routes_town05_long_complete.xml #look at leaderboard/data/all_routes
export SCENARIOS=leaderboard/data/scenarios/town05_all_scenarios_old.json #look at leaderboard/data/scenarios town05_all_scenarios OR no_scenarios.json
