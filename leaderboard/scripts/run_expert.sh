...
export SAVE_PATH=/media/fachri/banyak/endtoend/data/ADVERSARIAL/${WEATHER}-fix/Town${SCENARIO_ROUTE}_${ROUTE_TYPE} # ADVERSARIAL NORMAL
export ROUTES=leaderboard/data/all_routes/routes_town${SCENARIO_ROUTE}_${ROUTE_TYPE}_complete.xml #lihat di /leaderboard/data/all_routes
